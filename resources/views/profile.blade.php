	                ...
	                @if($list->is_active)
		                <div class = "col-md-4">
			                <table class = "table table-bordered">
			                	<tr><td class = "listingCell" onclick="window.location = '../../houseTemplate/{{$listing->listing_id}}'">
			           				...
			           				<table class = "listingData table table-condensed">	
			           					<tr><td class = "dataTitle">
											<h2> {{$list->listing_title}} <h2>
										</td></tr>
										<tr><td class = "dataPrice">
	...
	@else
		<div>
			@if(Auth::user()->user_id == $user->user_id)
				<p>You have no listings! <a href="../addListing">Click Here to add a new listing!</a></p>
			@else
